# Phase B: Layer 3 retrained on MM-B (per-source heads + ROM-aware) learned Layer 2 (Agent MM → v27)

**Date:** 2026-06-02
**Build:** Agent MM Phase B — v27 candidate (sister of v26)
...
| Slot | v25 CCC (reader) | v27 CCC | v27 LoA half | Tier | Crossed 0.79? |
| --- | --- | ---: | ---: | --- | :---: |
| hip_adduction_r / front_oblique_left | 0.69 (v20 (LL/v25)) | -0.518 | ±6.48° | Poor | no |
| lumbar_extension / front_oblique_left | 0.71 (v18 (LL/v25)) | 0.516 | ±8.37° | Moderate | no |
| lumbar_extension / side_left | 0.88 (v23 (LL/v25)) | 0.642 | ±9.75° | Good | no |
| lumbar_extension / side_right | 0.85 (v23 (LL/v25)) | 0.357 | ±12.35° | Poor | no |
| lumbar_extension / front_oblique_right | 0.79 (v23 (LL/v25)) | 0.668 | ±9.51° | Good | no |

## Promotions vs v17 baseline (v27 alone)

- knee_angle_r / front_oblique_left: Poor -> Moderate
- lumbar_extension / front_oblique_right: Moderate -> Good

## Demotions vs v17 baseline (v27 alone)
...
- `results/deploy_ready_models_v27_persource_romaware.json` — v27 deploy candidate
- `data/layer3_retrain_persource_romaware/per_slot_validity_v27.json` — per-slot v27 validity stats
