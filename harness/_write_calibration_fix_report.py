"""One-shot writer for data/calibration_fix/REPORT.md.

Keeping the report content in a Python script means re-running
apply_calibration_fix.py + this writer regenerates the deliverable
deterministically without touching any markdown tooling.
"""
from pathlib import Path

REPORT = """# Couro v15 Calibration Fix: LOSO-Safe Bias Correction + Front-Center Demotion
...
OUT = Path(
    "/Users/cameronvan/Documents/Claude/Projects/Couro/research-agent/multiview-validation/data/calibration_fix/REPORT.md"
)
