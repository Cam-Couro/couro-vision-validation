"""DWPose-L (UCoco-384) inference driver — CUDA flavor for AWS g5.xlarge.

Same structure as aspset_infer_gpu.py (which produced the v12 RTMPose keypoints).
Outputs 133-keypoint COCO-WholeBody predictions remapped into Halpe-26 layout so
the downstream pipeline doesn't need any changes.
"""
...
def dwpose_to_halpe26(xy_dw, conf_dw):
    """Remap COCO-WholeBody 133 keypoints into Halpe-26 layout."""
    CW = {
